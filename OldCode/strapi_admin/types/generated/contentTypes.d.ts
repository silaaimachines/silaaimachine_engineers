...
export interface ApiCustomerCustomer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    CustomerID: Schema.Attribute.String & Schema.Attribute.Private;
    CustomerName: Schema.Attribute.String & Schema.Attribute.Private;
    ContactNumber: Schema.Attribute.BigInteger & Schema.Attribute.Private;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiItemItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ItemPrice: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiServiceRegistrationServiceRegistration
  ...
  attributes: {
    ...
    JobNumber: Schema.Attribute.BigInteger;
    CustomerID: Schema.Attribute.String;
    ServiceStatus: Schema.Attribute.Enumeration<['Pending', 'Finished']> &
...
export interface ApiServicingDoneServicingDone
  extends Struct.CollectionTypeSchema {
  collectionName: 'servicing_dones';
  info: {
    singularName: 'servicing-done';
    pluralName: 'servicing-dones';
    displayName: 'Servicing Done';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    JobNumber: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    ServiceTypeDone: Schema.Attribute.Enumeration<
      [
        'Checking',
        'Free Service',
        'Full Service',
        'Full Service and Wash',
        'Over Oiling and Checking',
        'Standard Service',
        'Others',
      ]
    > &
    ...
    > &
      Schema.Attribute.Required;
    ExtraService: Schema.Attribute.Text;
    JobDoneBy: Schema.Attribute.String;
    ServiceStatus: Schema.Attribute.Enumeration<['Pending', 'Finished']> &
      Schema.Attribute.Private &
      Schema.Attribute.DefaultTo<'Finished'>;
    SparePartsUsed: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::servicing-done.servicing-done'
    > &
      Schema.Attribute.Private;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::servicing-done.servicing-done': ApiServicingDoneServicingDone;
