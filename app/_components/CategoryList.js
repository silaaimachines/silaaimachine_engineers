...
const CategoryList = ({ categoryList }) => {
  ...
  return (
    <div className='px-5'>
      ...
      <h1 className='font-semibold underline decoration-red-500 text-lg md:text-3xl'>Categories</h1>
      </div>
        ...
        <div className="flex space-x-5">
          {categoryList.map((category, index) => (
            <motion.div
              ...
              className='flex flex-col items-center justify-center transition duration-300 ease-in-out rounded-t-lg border shrink-0 shadow-sm cursor-pointer hover:border-[#e42584]'
            >
              <Image
              ...
              />
              <div className='w-full bg-[#e42584]'>
